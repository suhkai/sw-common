...
(e = function () {
	...
	var e = {},
		r = {};
	try {
		'undefined' != typeof window && (e = window), 'undefined' != typeof document && (r = document);
	} catch (e) {}
	function i() {
	...
	d &&
		((p = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(u.readyState)) ||
	...
	var y =
		((function (e) {
			...
			function c(e, t) {
				...
				for (
					var c = 1732584193, a = -271733879, s = -1732584194, l = 271733878, f = 0;
					f < e.length;
					f += 16
				)
					(c = d((n = c), (o = a), (r = s), (i = l), e[f], 7, -680876936)),
						...
						(c = p(c, (a = m(a, s, l, c, e[f + 12], 20, -1926607734)), s, l, e[f + 5], 4, -378558)),
						...
						(c = g(c, (a = p(a, s, l, c, e[f + 2], 23, -995338651)), s, l, e[f], 6, -198630844)),
			...
			function o(e) {
				for (var t, n = '0123456789abcdef', o = '', r = 0; r < e.length; r += 1)
					(t = e.charCodeAt(r)), (o += n.charAt((t >>> 4) & 15) + n.charAt(15 & t));
				return o;
			}
			function n(e) {
			...
			function i(e, t) {
				return (function (e, t) {
					var n,
						...
						i = [];
					for (
						r[15] = i[15] = void 0, 16 < o.length && (o = c(o, 8 * e.length)), n = 0;
						n < 16;
						n += 1
					)
						(r[n] = 909522486 ^ o[n]), (i[n] = 1549556828 ^ o[n]);
					return (t = c(r.concat(l(t)), 512 + 8 * t.length)), s(c(i.concat(t), 640));
				})(n(e), n(t));
			}
			function t(e, t, n) {
	...
	function O(e) {
		...
		return new Promise(function (o, r) {
			!(function t(e, n) {
				setTimeout(function () {
					var e = i();
					a && console.info(s), e ? o(e) : (e = 250 + n) <= c ? t(250, e) : r('timeout');
				}, e);
			})(n, 0);
		});
	}
			...
			('file://' !== f.location.origin && e.origin !== f.location.origin) ||
				(e &&
					...
					('fontawesome-conflict' === e.data.type
						...
						: 'no-conflict' === e.data.type && (n.noConflict[e.data.md5] = e.data)));
		};
		var o = C(u.currentScript),
			e = (function () {
				var e = Array.from(u.getElementsByTagName('link')).filter(function (e) {
					...
					t = Array.from(u.getElementsByTagName('style')).filter(function (e) {
						return (
							...
							(!f.FontAwesomeConfig ||
								!e.innerText.match(
									new RegExp('svg:not\\(:root\\)\\.'.concat(f.FontAwesomeConfig.replacementClass))
								))
						);
					});
				function n(e, t) {
								...
								parent.FontAwesomeDetection.__pollUntil({
									fn: function () {
										var e = document.getElementById(t),
											e = window.getComputedStyle(e).getPropertyValue('font-family');
										return !(!e.match(/FontAwesome/) && !e.match(/Font Awesome [56]/));
									}
								})
									.then(function () {
										var e = document.getElementById(n);
				...
				for (var a = 0; a < t.length; a++) {
					...
					s.setAttribute('id', w);
					var l = b(t[a]);
					s.setAttribute(A, l), (s.innerText = t[a].innerText), (o[l] = t[a]), n(s, l);
				}
				return o;
			})(),
			r = c(c({}, o), e),
			i = Object.keys(o).length + Object.keys(e).length,
			e = f.FontAwesomeDetection.timeout + f.FontAwesomeDetection.resultsCollectionMaxWait;
				  ...
				  console.info(
						"We'll wait about ".concat(
							...
							'then up to another '.concat(
								Math.round(f.FontAwesomeDetection.resultsCollectionMaxWait / 10) / 100,
	...
	var S = f.FontAwesomeDetection || {},
		N = c(
			...
			{},
			{ __pollUntil: O, md5ForNode: b, detectionDone: !1, nodesTested: null, nodesFound: null }
		);
