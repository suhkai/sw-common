/*
 ShibDrops
 Verified on 14/04-2022
 $DROPS
 */
//  Contract code is here https://etherscan.io/address/0x8b363ae782d3befac259c2b8bd887598f5c7e093#code
//  Official Website: https://shib-drops.com/
//  Official Telegram: https://t.me/+Ou7o3aiX7dY4ZWI0
//  Official Twitter: https://twitter.com/ShibDrops_                                                                                     
//  Official Gitbook: https://drive.google.com/file/d/1rYvKlBGU_LFs7QD7e7J-XTgKoDAOt75b/view
...
contract ShibDrops is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "ShibDrops"; 
    string private constant _symbol = "DROPS"; 
    ...
    uint256 private _taxFeeOnBuy = 30; // updated

    //Sell Fee
    uint256 private _redisFeeOnSell = 0; //
    uint256 private _taxFeeOnSell = 50; // updated
    ...
    address payable private _developmentAddress =
        payable(0xc5B19AFa28127664501C1bd0A7d2e608Bd029d63); // updated
    ...
    uint256 public _maxTxAmount = 10000 * 10 ** 6; // 1%
    uint256 public _maxWalletSize = 20000 * 10 ** 6; // 2%
