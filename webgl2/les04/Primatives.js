...
Primatives.GridAxis = class {
	static createMesh(gl){
		...
		var verts = [],
			size = 1.99,			// W/H of the outer box of the grid, from origin we can only go 1 unit in each direction, so from left to right is 2 units max
		...
		//Setup our Buffer
		gl.bindVertexArray(mesh.vao); // select vao
